# -*- coding: utf-8 -*-
"""
Created on Mon May 10 15:22:52 2021
...
def calc_distr_normal(ts, var = 'dis24'):
    ...
    for tw in time_window:    
        ...
        for feature in features:
            ...
            # for subset in time_subsets: 
                ...
                # if feature in stat_features:
                #     return_params = func_dict[feature]['cols'] 
                    
                #     result_buffer = 
                    
                    # result_buffer = slice_buffer.apply(func_dict[feature]['func'])
            
            # if feature in stat_features:
            #     print(feature) 
            #     return_params = func_dict[feature]['cols']
            #     print(calc_buffer.groups)
                
            #     if feature == 'normal':
            #         mu_b, sig_b = calc_buffer.apply(func_dict[feature]['func'])
                    
                    # print(ar_mu.dis24.values.shape)
                    # 
...
def pa_calc_signatures(gauge_id, input_dir, obs_dir, gauge_fn): 
    ...
    if fn_sim.exists() and fn_obs.exists() and gauge_fn.exists(): 
        ...
        ## read gauge data into xarray dataset 
